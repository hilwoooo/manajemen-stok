                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= isset($total_proses) ? $total_proses : 0; ?> Unit</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp <?= isset($total_pendapatan) ? number_format($total_pendapatan, 0, ',', '.') : 0; ?></div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <p>Selamat Datang, <strong><?= htmlspecialchars($_SESSION['nama']); ?></strong> di Web Admin Toko Komputer & Servis Laptop. Gunakan menu di sebelah kiri untuk mengelola stok gudang, memantau antrean laptop konsumen, serta memproses transaksi biaya servis secara real-time.</p>
                </div>
            </div>
        </div>
    </div>
